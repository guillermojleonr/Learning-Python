...
miImagen=PhotoImage(file=r"C:\Users\guill\Documents\Learning-Python\GUI\mouse.png") #r converts normal string to raw string, where backlashes aren't treated as a scape character.
