...
def totalizacion():
    global resultado
    numeroPantalla.set(resultado+float(numeroPantalla.get())) #totaliza
...
""" ---------------Pantalla ------------------- """
pantalla=Entry(miFrame,textvariable=numeroPantalla) #textvariable muestra en pantalla el valor de una variable de texto en todo momento, incluso cuando cambia de valor
